        ...
        protected void gvUncompletedPA_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (approveStatus != 0 && approveStatus != 5)
                {
                    ...
                    LinkButton btnDel = (LinkButton)e.Row.FindControl("btnDeletePA");
                    btnDel.OnClientClick = " alert ('Since you have already submitted Performance Assessment and e-mail reminder accordingly has been sent to your mentor, you cannot delete this record. For any further requirement, please contact MSRA Intern Support <msrainte@microsoft.com> or Jennifer Cao <a-jcao@microsoft.com>.' );return false;";
                    btnDel.CommandName = null;
                }
                else
                {
                    IncompletedPACount++;
