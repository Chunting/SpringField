...
public partial class PageApplicantRelatedInfo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        btnFirstDate.Attributes.Add("onclick", "popUpCalendar(this,document.all." + tbFirstDate.ClientID + ",'mm/dd/yyyy');");
        btnSecondDate.Attributes.Add("onclick", "popUpCalendar(this,document.all." + tbSecondDate.ClientID + ",'mm/dd/yyyy');");
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    lbMsg.Text = "Availability Date should be later than today!";
        //    return;
        //}
