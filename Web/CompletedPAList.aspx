<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompletedPAList.aspx.cs"
    Inherits="CompletedPAList" MasterPageFile="~/SpringfieldMaster.master" %>
...
<asp:Content ID="cntGeneralInfo" runat="server" ContentPlaceHolderID="mainPlaceHolder">
    ...
    <asp:GridView ID="gvCompletedPA" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <a id="A1" runat="server" href='<%# GetViewLink(DataBinder.Eval(Container.DataItem, "ApplicantId").ToString(),DataBinder.Eval(Container.DataItem, "id").ToString()) %>'>
                        View
                    </a>&nbsp;&nbsp;<a id="A2" runat="server" href='<%# GetEditLink(DataBinder.Eval(Container.DataItem, "id").ToString()) %>'>
                        Edit
                    </a>
                </ItemTemplate>
                <HeaderTemplate>
