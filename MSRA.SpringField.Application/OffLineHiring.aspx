<%@ Page Language="C#" AutoEventWireup="true" Inherits="MSRA.SpringField.Application.OffLineHiring"
    MasterPageFile="~/SpringfieldMaster.master" CodeBehind="OffLineHiring.aspx.cs" %>
        ...
        <div>
            ...
            <div id="ch_content" class="panel_content">
                <table class="applicants_table">
                    ...
                    <tr>
                        <td style="height: 39px">Major Category:
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Label ID="Label1" runat="server" Text="Please chose your actual PM if he is not Baining Guo" Style="color: #FF0000"></asp:Label>

                        </td>
                    </tr>
                    <tr>
                        <td>Group Manager's Approval:
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>You can fill this form to hire a student directly. A email will be automatically
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <div style="padding: 0 10; height: 30; width: 500px"
                                onmouseover="this.style.borderStyle='solid';this.style.borderWidth='1';this.style.borderColor='#B6C2D8';"
                                onmouseout="this.style.borderWidth='0';">
                                <!-- Add CheckBox by Yuanqin, 2011.3.25 -->
