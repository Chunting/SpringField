...
namespace MSRA.SpringField.Application.Keyin
{
    public partial class PageApplicantEduBackground : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (enrollDate > theDate)
                {
                    lbMsg.Text = "Enroll Date must be less than Graduate Date!";
                    return;
                }
            ...
            Response.Redirect(string.Format("ApplicantRelatedInfo.aspx?email={0}", Server.UrlEncode(email)));
