...
namespace MSRA.SpringField.Application.Controls
{
    public partial class Controls_Comment : System.Web.UI.UserControl
    {
        ...
        protected void btnAddComment_Click(object sender, EventArgs e)
        {
            ...
            JSUtility.Alert(this.Page, "Note was added successfully!");
            BindData();
        }
        ...
        public Guid ApplicantId
        {
            get
            {
                object guid = ViewState["comment_applicantid"];
                if (guid != null)
                {
                ...
                else
                {
                    ...
                    {
                        return new Guid(Request.QueryString["applicant"].ToString());
                    }
                    else
                    {
                        return Guid.Empty;
        ...
        protected void gvComments_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                case "DeleteComment":
                    ...
                    BindData();
                    JSUtility.Alert(this.Page, "Note was deleted successfully!");
                    break;
                default:
                    break;
            }
