<%@ Control Language="C#" AutoEventWireup="true" Inherits="MSRA.SpringField.Application.Controls.Controls_SRDegree" Codebehind="SRDegree.ascx.cs" %>
<br />
<asp:GridView CssClass="applicants_table" ID="gvDegree" runat="server" AutoGenerateColumns="false" Width="100%">
    <Columns>
            <asp:TemplateField>
            <ItemTemplate>
                <%# Eval("Degree")%>
