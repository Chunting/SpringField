<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="MSRA.SpringField.Application.Controls.Controls_IncompleteInterviewList" Codebehind="IncompleteInterviewList.ascx.cs" %>
            ...
            <asp:Panel ID="panInfo" runat="server" CssClass="modalPopup">
                <div>
                    ...
                    <p style="text-align: center;">
                        <asp:Button ID="OkButton" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "FeedbackId") %>' runat="server" Text="OK"  Width="120" OnCommand="OkButton_Click" />
