<%@ Page Language="C#" AutoEventWireup="true" Inherits="MSRA.SpringField.Application.Keyin.Error" Codebehind="Error.aspx.cs" %>
...
<body>
    ...
    Error Message (Please report it to the site adminstrator):
    </div>
