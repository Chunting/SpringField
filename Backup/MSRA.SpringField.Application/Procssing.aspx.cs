...
{
    public partial class Procssing : System.Web.UI.Page
    {
        ...
        private void BindData(Int32 pageIndex, Int32 pageSize, Boolean isRefresh)
        {
            ...
            {
                dv = new DataView(Interview.GetAllProcessingInterview().Tables[0]);
            }
            else
            {
                dv = new DataView(Interview.GetInterviewForCurrentUser(SiteUser.Current.SiteUserId, SiteUser.Current.Alias).Tables[0]);
            }
