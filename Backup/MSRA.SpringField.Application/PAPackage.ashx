...
public class PAPackage : IHttpHandler {
    ...
    private string GetPAinfo(Guid PAId)
    {
        ...
        MSRA.SpringField.Components.BizObjects.PerformanceAssessment curPA = MSRA.SpringField.Components.BizObjects.PerformanceAssessment.GetPerformanceAssessmentById(PAId);
        ...
        rm.AddField("Group Manager Alias", MSRA.SpringField.Components.BizObjects.SiteUser.GetAliasByUserId(curPA.GroupMgrId).Trim());
        ...
        if (curPA.Department > 0 && PAResourceManager.IdToText("Department", curPA.Department) == "MSRA")
        {
            ...
            DataSet dsPublications = MSRA.SpringField.Components.BizObjects.InternPublication.GetInternPublicationByPAId(curPA.Id);
