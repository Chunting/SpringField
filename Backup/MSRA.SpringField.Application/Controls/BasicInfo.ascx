<%@ Control Language="C#" AutoEventWireup="true" Inherits="MSRA.SpringField.Application.Controls.Controls_BasicInfo" Codebehind="BasicInfo.ascx.cs" %>

<div>
<div id="ch_title" style="border-bottom:none 0px #000" class="panel_title_expand">
...
<tr>
    ...
    <td width="25%">
        <asp:HyperLink ID="lnkApplicantName" runat="server" Target="_self"></asp:HyperLink>
    </td>
    <td width="10%">
        Degree:
    </td>
...
<td colspan="3"><asp:HyperLink Target="_blank" runat="server" ID="lbPAURL"></asp:HyperLink></td>
</tr>
<%--Add SurveyLink by Yuanqin, 2011.5.25--%>
<tr id="trSurveyURL" runat="server" visible="false">
<td>Checkout Survey Web<br /> Address for Intern:</td>
<td colspan="3"><asp:HyperLink Target="_blank" runat="server" ID="lbSurveyURL" ></asp:HyperLink></td>
</tr>
</table>
