...
namespace MSRA.SpringField.Application.Management
{
    public partial class Management_EmailTemplateEditor : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            templateList.Add(new ListItem("PA Incomplete Remind", EnumHelper.EnumToString(MailType.PAIncompleteRemind)));    //Add by Yuanqin, 2011.5.27
            templateList.Add(new ListItem("Daily PA Report", EnumHelper.EnumToString(MailType.DailyPAReport)));
            templateList.Add(new ListItem("PA Aprroval Reject", EnumHelper.EnumToString(MailType.PAApprovalRejected)));
            templateList.Add(new ListItem("Checkout Survey", EnumHelper.EnumToString(MailType.CheckoutSurvey)));       //Add by Yuanqin, 2011.6.2
            templateList.Add(new ListItem("Notice Applicant", EnumHelper.EnumToString(MailType.NoticeApplicant)));//Add by bin, 2011.12.30
            //templateList.Add(new ListItem("Checkout Reminder 23", EnumHelper.EnumToString(MailType.CheckOutReminder)));//Add by LMM, 2012.11.23
