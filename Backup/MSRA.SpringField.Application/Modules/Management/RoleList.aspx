<%@ Page Title="" Language="C#" MasterPageFile="~/SpringfieldMaster.master" AutoEventWireup="true" CodeBehind="RoleList.aspx.cs" Inherits="MSRA.SpringField.Application.Modules.Management.RoleList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="mainPlaceHolder" runat="server">
<div class="panel_title_expand" style="width:100%">Role List</div>
    ...
    <table cellpadding="0" cellspacing="0" width="100%"> 
        <tr>
            ...
            <div style="padding:5 5 3 5">
                    <a href="RoleEdit.aspx" style="color:Black"><img alt="Create new role" src="../../Resource/Images/create.png" width="24" height="24" align="absmiddle" style="margin:0 3"/>Create Role</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <label for="<%=ImageButton1.ClientID %>"><span style="cursor:hand">Delete Role(s)</span></label>
            </div>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="border-left:none;border-right:none">
                <div style="width:100%;margin:3 3">                                                 
                    <asp:GridView HeaderStyle-Height="35" ID="gvRoles" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="15" 
                    ...
                    <Columns>
                        <asp:TemplateField ItemStyle-Width="50" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <input type="checkbox" id="cb_ischeck" name="cb_ischeck" value='<%# Eval("RoleId") %>'/>
                            </ItemTemplate>
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Role Name" HeaderStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <a href='RoleView.aspx?roleid=<%# Eval("RoleId") %>'><%# Eval("RoleName")%></a>
                            </ItemTemplate>
                        </asp:TemplateField>
                                                                
                        <asp:BoundField HeaderText="Lowered Role Name" DataField="LoweredRoleName" HeaderStyle-HorizontalAlign="Left" />
        ...
        <tr>
            ...
            <div style="padding:4 5">
                ...
                <label for="<%=btnDelete.ClientID %>"><span style="cursor:hand">Delete Role(s)</span></label>
            </div>
            </td>
        </tr>
    </table>
